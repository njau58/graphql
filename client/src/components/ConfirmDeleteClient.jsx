...
const ConfirmDeleteClient = ({ client, toggleModal }) => {
...
alert(error)
  ...
  const removeClient = () => {
    // deleteClient.then(() => toggleModal()).catch((error) => alert(error));
          ...
          <div class="relative  z-40 p-4 text-center bg-white rounded-lg max-w-lg  mx-auto shadow dark:bg-gray-800 sm:p-5">
            ...
            <div className=" bg-red-50 text-red-800 rounded-md mb-4 px-2 py-6">
              ...
              <p className="text-start mt-2">
                By deleting this client, projects associated will also be
                permanently deleted.
              </p>
            </div>
